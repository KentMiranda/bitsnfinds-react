export const CONFIG = {
  ...
  order: {
    ...
    infoItems: [
      ...
      'After submitting, message our Facebook page with your name and order details',
    ],
    productOptions: [
      'Name / Word Board',
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'We accept Venmo, cash, or Cash App. Payment details will be confirmed when your order is discussed.',
    },
  ],
  ...
  contact: {
    ...
    links: [
      { icon: '📘', label: 'Facebook', value: 'Bits & Finds', href: 'https://www.facebook.com/profile.php?id=61569581906966'},
      { icon: '📸', label: 'Instagram', value: '@bitsn.finds', href: 'https://www.instagram.com/bitsn.finds' },
      { icon: '💬', label: 'Messenger', value: 'Message us directly', href: 'm.me/486155667921348'},
      { icon: '📧', label: 'Email', value: 'bitsnfinds5@gmail.com', href: 'mailto:bitsnfinds5@gmail.com'},
    ],
  },
