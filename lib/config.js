export const CONFIG = {
  ...
  brand: {
    name: 'Bits & Finds',
    tagline: 'Precision engraving, made personal',
  ...
  hero: {
    eyebrow: 'Bits & Finds Laser Engraving',
    titleLine1: 'Made with precision,',
    titleLine2: 'made with heart',
    subtitle: 'Custom laser engraving and personalized pieces, made to order with care.',
  ...
  about: {
    ...
    titleEm: 'a story',
    body: 'Bits & Finds creates custom laser-engraved pieces that turn meaningful names, words, and memories into lasting keepsakes. Each design is made with precision and care to bring your ideas to life.',
    image: '',
    values: [
      { icon: '⚡', title: 'Laser Engraved', desc: 'Clean, precise engraving for names, designs, logos, and meaningful messages.' },
      { icon: '✂️', title: 'Laser Cut', desc: 'Custom shapes and decorative pieces made with accurate, detailed cuts.' },
  ...
  services: {
    ...
    titleEm: 'to something tangible',
    items: [
      {
        number: '01',
        title: 'Custom Design Services',
        icon: '✦',
        body: 'Bring us your idea and we will help shape it into a design made for your project. From logos and artwork to intricate patterns and special requests, we create personalized designs ready for engraving or cutting.',
      },
      {
        number: '02',
        title: 'Laser Engraving',
        icon: '✎',
        body: 'Add names, messages, portraits, logos, and detailed artwork to create a lasting personal touch. Our precise engraving turns meaningful ideas into gifts, keepsakes, and branded pieces.',
      },
      {
        number: '03',
        title: 'Laser Cutting',
        icon: '✂',
        body: 'Create clean, accurate shapes, signs, decorative pieces, and custom details. We work with your design to produce carefully cut pieces with the detail your project deserves.',
      },
    ],
  },
