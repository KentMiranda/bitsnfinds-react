...
export const CONFIG = {
  ...
  about: {
    ...
    titleEm: 'a story',
    body:    'Bits & Finds creates custom wood engravings that turn meaningful names, words, and memories into lasting pieces. Each design is carefully burned by hand into native Philippine hardwood, bringing warmth, craftsmanship, and personal story into everyday spaces.',
    image:   '',
    values: [
