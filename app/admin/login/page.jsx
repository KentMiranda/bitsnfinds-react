    ...
    <div className="min-h-screen bg-cream flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-bark rounded-lg flex items-center justify-center text-2xl mx-auto mb-3">
            🌿
          </div>
        ...
        <form onSubmit={handleSubmit} className="bg-paper border border-mist rounded-lg p-6 flex flex-col gap-4">
          {error && (
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-full border border-mist rounded-sm px-3 py-2.5 text-sm text-ink bg-cream focus:outline-none focus:border-sage transition-colors"
            />
          </div>
